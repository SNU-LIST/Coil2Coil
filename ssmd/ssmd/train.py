...
"""
Using Cluster
rm -rf /home/juhyung/gate/denoising/ssmd
cp -rf /home/juhyung/window/denoising/ssmd /home/juhyung/gate/denoising/
cp -rf /home/juhyung/ctx/juhyung/ssmd /home/juhyung/gate/denoising/
...
Cd Run Path
conda activate ssmd
cd /home/juhyung/gate/denoising/ssmd/ssmd

Command
python train.py -dir D:/gate/denoising/log/ -a n2c -t D:/gate/denoising/data/brainval_v2.h5 -v D:/gate/denoising/data/brain_sample_v3.h5 -noise gauss0.5


python eval.py -m D:/gate/denoising/paper/result_v2/real/training/c2c/model_history/model_00030.training -d D:/gate/denoising/data/fastMRI_brain_DICOM\\509293915060 -dir D:/gate/denoising/logeval/ -noise inf



python eval.py -m D:/gate/denoising/paper/result_v2/real/training/cs/model.training -d D:/gate/denoising/data/fastMRI_brain_DICOM\\509293915060  -dir D:/gate/denoising/logeval/ -noise inf
"""
...
def parse():
    ...
    parser.add_argument("--train_dataset","-t", default = '/fast_storage/juhyung/braintrain_v2.h5')
    parser.add_argument("--train_mask","-tm")
    parser.add_argument("--validation_dataset","-v", default = '/fast_storage/juhyung/brainval_v2.h5')
